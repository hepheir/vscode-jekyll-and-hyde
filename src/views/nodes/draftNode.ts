...
export class DraftNode extends vscode.TreeItem {
    constructor(
        ...
        this.iconPath = {
            light: vscode.Uri.file(this.context.asAbsolutePath(path.join('images', 'draft-light.svg'))),
            dark: vscode.Uri.file(this.context.asAbsolutePath(path.join('images', 'draft-dark.svg')))
        };
    }
}
